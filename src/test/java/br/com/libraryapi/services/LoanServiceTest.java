...
public class LoanServiceTest {
    ...
    public void findLoanTest() {
        final String customer = "João";
        final String isbn = "12547";

        LoanFilterDTO filterDTO = LoanFilterDTO.builder().customer(customer).isbn(isbn).build();

        Book book = Book.builder().id(15L).isbn(isbn).title("Searching").author("Pedro").build();
        Loan loan = Loan.builder().id(1L).loanDate(LocalDate.now()).customer(customer).book(book).build();
